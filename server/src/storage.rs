...
/// Repo root, one level above the `server/` crate manifest — kept as its own
/// helper because both data-dir functions below need to compensate for the
/// crate living at `server/` instead of the repo root (2026-07-12 reorg).
