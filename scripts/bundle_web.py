...
def main():
    ...
    swift_protocol_dir = os.path.join(project_root, "apps", "macos", "Sources", "ZaliMessenger")
    ...
    dest_paths = [
        os.path.join(project_root, "apps", "macos", "Sources", "ZaliMessenger", "Assets.swift"),
    ]
    ...
    resources_web_dir = os.path.join(project_root, "apps", "macos", "Sources", "ZaliMessenger", "Resources", "Web")
